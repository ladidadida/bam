...
class ActionResult(_message.Message):
    ...
    def __init__(
        self,
        output_files: _Iterable[OutputFile | _Mapping] | None = ...,
        output_directories: _Iterable[OutputDirectory | _Mapping] | None = ...,
        exit_code: int | None = ...,
        stdout_raw: bytes | None = ...,
        stderr_raw: bytes | None = ...,
        stdout_digest: Digest | _Mapping | None = ...,
        stderr_digest: Digest | _Mapping | None = ...,
    ) -> None: ...
...
class OutputDirectory(_message.Message):
    ...
    tree_digest: Digest
    def __init__(
        self, path: str | None = ..., tree_digest: Digest | _Mapping | None = ...
    ) -> None: ...
...
class GetActionResultRequest(_message.Message):
    ...
    def __init__(
        ...
        action_digest: Digest | _Mapping | None = ...,
        inline_stdout: bool = ...,
        inline_stderr: bool = ...,
        inline_output_files: _Iterable[str] | None = ...,
    ) -> None: ...
...
class UpdateActionResultRequest(_message.Message):
    ...
    def __init__(
        ...
        instance_name: str | None = ...,
        action_digest: Digest | _Mapping | None = ...,
        action_result: ActionResult | _Mapping | None = ...,
        results_cache_policy_priority: int | None = ...,
    ) -> None: ...
